...
<head>
    ...
    <title>Clément Merouani | LEROY MERLIN</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="infos__full">
                            ...
                            <p class="second_line_p">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec,
                                pellentesque eu, pretium quis, um sociis natoque penatibus et magnis dis parturient sem. </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="bloc_credit">
                            ...
                            <p class="credits_second">
                                Configurateur de portes de placard
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 col-xs-12 col-sm-12">
                        <img class="logo_brand" src="images/logo_brand_lm.png" alt="logo_brand">
                    </div>
                    <div class="col-md-8">
                        <p class="brand">
                            Acteur majeur sur le marché mondial du bricolage, Leroy Merlin accompagne les habitants dans la mise en oeuvre de leurs projets. Entreprise pionnière de GROUPE ADEO, Leroy Merlin est spécialisé dans la vente de produits et solutions avec une promesse
                            unique : offrir des solutions de bricolage à chacun.
                        </p>
                    </div>
                </div>
            </div>
        </section>
        <section class="vimeo__box">
            <div class="container">
                <div class="row">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="//player.vimeo.com/video/101286638"></iframe>
                    </div>
                </div>
            </div>
            <div class="clearBoth"></div>
        </section>
        <section class="homepage_project">
            <div class="container-fluid">
                <div class="row">
                    <img src="images/bgc_homepage_lm.png" alt="" style="width:100%; height:100%; visibility:hidden;">
                </div>
            </div>
        </section>
